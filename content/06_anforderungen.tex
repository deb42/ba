...
Hierbei wurden die Anforderungen in die Kategorien \textit{Funktionale} und \textit{Nicht-Funktionale Anforderungen} unterteilt \cite{}. \textit{Funktionale Anforderungen} beschreiben Fähigkeiten des Systems, die von einem Anwender erwartet werden, damit dieser mit Hilfe dieses Systems ein fachliches Problem gelöst werden kann. \textit{Nicht-Funktionale Anforderungen} definieren hingegen die grundlegenden Eigenschaften des Systems. Über Userstories werden die Anforderungen veranschaulicht.
