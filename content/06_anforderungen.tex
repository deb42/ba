...
\paragraph{() Studierende soll Überblick über aktuellen Aufgabenstand erhalten}
\begin{quote}
...
\paragraph{(2) Der Lehrende soll eine Auswahlmöglichkeit erhalten, zwischen Datenstrukturen wählen zu können}
\begin{quote}
